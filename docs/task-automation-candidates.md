...
- **Blast radius:** hazardous, it could leave clients experiencing critical
...
- **How intensive:** minimal, a routine task the team handles ad hoc.
...
- **Blast radius:** destructive, many variables to consider, could negatively
